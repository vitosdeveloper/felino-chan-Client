...
function Footer(props) {
  ...
  return (
    <div>
      <a className='boardLinks aPostCreator' href='#top'>
        [Go to the top]{' '}
      </a>
      <br />
      {props.pages === true ? (
      ...
      <div className='footerSmall'>
        <small>
          ...
          <p>
            Sistema de sage funcionando (escreva "sage" no campo de e-mail para
            não bumpar um tópico/thread)
          </p>
          ...
          <p>
            Tudo que está escrito nesse fórum não passa de ficção. Somente um
            idiota levaria qualquer coisa aqui a sério.
          </p>
        </small>
      </div>
    </div>
